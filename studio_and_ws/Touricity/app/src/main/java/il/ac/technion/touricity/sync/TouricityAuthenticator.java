...
/**
 * Manages "Authentication" to Touricity's backend service.  The SyncAdapter framework
 ...
 */
public class TouricityAuthenticator extends AbstractAccountAuthenticator {

    public TouricityAuthenticator(Context context) {
        super(context);
    }
